      ...
      >
        <Fade in={open}>
          <div className={classes.paper}>
            ...
            <Typography>
              Diese Webseite und deren Inhalt wird durch eine private Person ohne kommerzielle
              Interessen zur Verfügung gestellt. Verantwortliche Stelle im Sinne der
              Datenschutzgesetze, insbesondere der EU-Datenschutzgrundverordnung (DSGVO), lautet:
              <br />
              <br />
              Andreas Gasser
              <br />
              ...
              <br />
              Webseite: <Link to="https://andreasgasser.com">andreasgasser.com</Link>
              <br />
              <br />
            </Typography>
            ...
            <Typography>
              Wenn Sie auf diese Webseite zugreifen werden automatisch Informationen allgemeiner
              Natur erfasst. Diese Informationen werden im Server-Logfile erfasst und beinhalten die
              Art des Webbrowsers, das verwendete Betriebssystem, den Domainnamen Ihres
              Internet-Service-Providers, Ihre IP-Adresse und ähnliches. Dies aus folgendem Grund:
              <ul>
              ...
              Informationen dieser Art werden lediglich statistisch ausgewertet, um unseren
            ...
            <Typography>
              ...
              Schriften. Die Datenschutzrichtlinie des Bibliothekbetreibers Google finden Sie hier:{' '}
            ...
            <Typography>
              ...
              so, als ob der Besucher die andere Website besucht hätte. Diese Websites können Daten
              über Sie sammeln, Cookies benutzen, zusätzliche Tracking-Dienste von Dritten einbetten
              und Ihre Interaktion mit diesem eingebetteten Inhalt aufzeichnen, inklusive Ihrer
              Interaktion mit dem eingebetteten Inhalt, falls Sie ein Konto haben und auf dieser
            ...
            <Typography>
              ...
              dem Webseitenbetreiber zu erbringen. Die im Rahmen von Google Analytics von Ihrem
              Browser übermittelte IP-Adresse wird nicht mit anderen Daten von Google
              zusammengeführt. Die Zwecke der Datenverarbeitung liegen in der Auswertung der Nutzung
              der Website und in der Zusammenstellung von Reports über Aktivitäten auf der Website.
            ...
            <Typography>
              ...
              Sie sich direkt an die für den Datenschutz zu Beginn der Datenschutzerklärung
              aufgeführten, verantwortlichen Person.
              <br />
              Frick, 06.06.2020
            </Typography>
            <br />
