...
const SWISS_GEO_URL =
  'https://wmts20.geo.admin.ch/1.0.0/ch.swisstopo.pixelkarte-farbe/default/current/3857/{z}/{x}/{y}.jpeg'; // eslint-disable-line max-len
...
const SwissGeoMap = React.forwardRef(
  ({ noStyles, children, mapAction, onViewportChanged, onClick, zoom, center, ...props }, ref) => {
